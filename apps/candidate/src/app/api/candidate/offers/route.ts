  ...
  try {
    ...
    const formattedOffers = (offers || []).map((offer) => {
      ...
      return {
        ...
        // Counter offer data
        counterOffers: counterOffers.map((co: any) => ({
          id: co.id,
          requestedSalary: Number(co.requested_salary) || 0,
          requestedCurrency: co.requested_currency || 'PHP',
        ...
        latestCounter: latest_counter ? {
          id: latest_counter.id,
          requestedSalary: Number(latest_counter.requested_salary) || 0,
          requestedCurrency: latest_counter.requested_currency || 'PHP',
          candidateMessage: latest_counter.candidate_message,
          employerResponse: latest_counter.employer_response,
          responseType: latest_counter.response_type,
          status: latest_counter.status,
          createdAt: latest_counter.created_at,
          respondedAt: latest_counter.responded_at,
        } : null,
      };
    });
