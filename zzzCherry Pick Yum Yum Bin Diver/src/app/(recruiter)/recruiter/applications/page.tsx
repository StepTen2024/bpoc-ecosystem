    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">Review candidates and manage your hiring pipeline</p>
        </div>
        <div className="flex items-center gap-3">
          <Button 
            ...
            className={`border-white/10 ${bulkMode ? 'bg-orange-500/20 text-orange-400 border-orange-500/30' : 'text-gray-400 hover:text-white'}`}
          >
