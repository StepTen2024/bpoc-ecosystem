        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            ...
            <Link href="/candidate/jobs">
              <Button className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white hover:shadow-lg hover:shadow-cyan-500/25 border-none transition-all hover:scale-105">
                Find Jobs
              </Button>
            </Link>
          </div>
            ...
            <div className="relative bg-[#0B0B0D]/80 rounded-xl p-6 md:p-8 backdrop-blur-xl">
              <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between mb-6">
                ...
                <div className="text-right">
                  <div className={cn("text-5xl font-black font-mono", colors.text)}>
