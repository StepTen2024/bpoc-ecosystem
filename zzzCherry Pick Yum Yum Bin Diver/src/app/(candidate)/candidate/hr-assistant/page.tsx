...
export default function CandidateHRAssistantPage() {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col">
      {/* Header */}
      <div className="flex-none border-b border-white/10 bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-cyan-500/10 px-8 py-6">
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          <div className="flex items-center gap-4">
            <div className="p-4 rounded-2xl bg-gradient-to-br from-cyan-500 to-purple-500 shadow-lg shadow-cyan-500/30">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 flex items-center gap-2 mt-1">
                ...
                Philippine Labor Law • Know Your Rights as a Worker
              </p>
            </div>
          </div>
          <div className="flex items-center gap-4">
      ...
      {/* Input Area */}
      <div className="flex-none border-t border-white/10 bg-[#0B0B0D]/95 backdrop-blur-xl px-8 py-6">
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          <div className="flex gap-4">
            <input
              ...
              placeholder="Ask about your rights, benefits, employment terms, or any labor law questions..."
              disabled={loading || !user}
              className="flex-1 px-6 py-4 bg-white/5 border border-white/10 rounded-2xl text-white text-base placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50 disabled:opacity-50 transition-all"
              autoFocus
            />
            <button
              type="submit"
              disabled={loading || !input.trim() || !user}
              className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 text-white rounded-2xl hover:shadow-xl hover:shadow-cyan-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:scale-105 flex items-center gap-3 font-semibold text-base"
            >
              {loading ? (
