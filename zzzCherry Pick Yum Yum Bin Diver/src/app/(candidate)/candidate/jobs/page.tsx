        ...
        >
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-12 h-14 bg-white/5 border-white/10 text-white text-lg placeholder:text-gray-500 rounded-2xl focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20"
            />
          </div>
                        ...
                        <div className="flex items-start justify-between gap-6">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start gap-4 mb-3">
                              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-purple-600/20 border border-cyan-500/30 flex items-center justify-center flex-shrink-0">
