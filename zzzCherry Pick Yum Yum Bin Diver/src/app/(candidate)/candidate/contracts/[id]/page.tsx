...
export default function CandidateContractViewPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0D] pb-12">
      {/* Header */}
      <div className="border-b border-cyan-500/20 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 px-8 py-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-4 rounded-xl bg-gradient-to-br from-cyan-500/20 to-purple-600/20 border border-cyan-500/30">
                <FileCheck className="w-8 h-8 text-cyan-400" />
              </div>
              <div>
                <h1 className="text-3xl font-bold text-white">Your Employment Contract</h1>
